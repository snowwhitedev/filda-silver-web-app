            ...
            pool.info.lpTokenStakedBalance > 0
                ? (
                    <Button
                        ...
                        {t('Stake.StakeMore')} {pool.info.lpTokenName} {pool.info.lpTokenSymbol}
                    </Button>
                )
                : pool.info.lpTokenStakedBalance
                    ? (
                        <Button
                            variant="primary" size="lg" block disabled={pool.info.disabled} onClick={() => handleShow('stake', i)}>
                            {t('Stake.Stake')} {pool.info.lpTokenName} {pool.info.lpTokenSymbol}
                        </Button>
                    ) : ''
                ...
                <div className={`${styles.tile} ${pool.info.stakeActive || pool.info.rewardsActive || pool.info.redpacketActive? styles.active : ''}`}>
                                ...
                                ? (
                                    <div className={styles.totalStakedContainer}>
                                        ...
                                        <div className={styles.value}>
                                            ...
                                            />
                                            <div className={styles.tokenName}>
                                                {pool.info.lpTokenStakedTotalSupplyFormatted} {pool.info.lpTokenSymbol}
                                            </div>
                                        </div>
                                    </div>
                                )
                                        ...
                                        <div className={styles.totalStakedContainer}>
                                            ...
                                            <div className={styles.value}>
                                                <img
                                                    ...
                                                    alt="token logo"
                                                />
                                                <div className={styles.tokenName}>{pool.info.totalRedpacket} {pool.info.lpTokenSymbol}</div>
                                            </div>
                                        </div>
                                    )
                                    : (
                                        <div className={styles.totalStakedContainer}>
                                            ...
                                            <div className={styles.value}>
                                                ...
                                                />
                                                <div className={styles.tokenName}>
                                                    {pool.info.totalRewards} {pool.info.lpTokenSymbol}
                                                </div>
                                            </div>
                                        </div>
                                    )
                                ...
                                <div className={styles.totalStakedContainer}>
                                    ...
                                    <div className={styles.value}>
                                        <img
                                            ...
                                            alt="token logo"
                                        />
                                        <div className={styles.tokenName}>{pool.info.totalRedpacketLeft} {pool.info.lpTokenSymbol}</div>
                                    </div>
                                </div>
                                :
                                <div className={styles.totalStakedContainer}>
                                    ...
                                    <div className={styles.value}>
                                        <img
                                            ...
                                            alt="token logo"
                                        />
                                        <div className={styles.tokenName}>{pool.info.totalRewardsLeft} {pool.info.lpTokenSymbol}</div>
                                    </div>
                                </div>
                        }
                                ...
                                <Row className={styles.infoItem}>
                                    ...
                                    <Col xs={8} className={styles.value}>
                                        <img
                                            ...
                                            alt="token logo"
                                        />
                                        <div className={styles.tokenName}>{pool.info.rewardsRedeemed} {pool.info.rewardTokenSymbol}</div>
                                    </Col>
                                </Row>
                                : ''
                        }
                        {
                            pool.info.rewardAPR !== undefined ?
                                <Row className={styles.infoItem}>
                    ...
                    <div className={styles.footerContainer}>
                        ...
                        <div className={styles.addressContainer}>
                            Pool Address:
                            <a href={CoreData.getAddressUrl(pool.address, networkType, pool.info.lpTokenId)} target="_blank">
