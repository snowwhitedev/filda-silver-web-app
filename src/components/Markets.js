      ...
      <Row className={styles.marketsItemRow} key={market.symbol}>
        ...
        <Col md={3} lg={2} className={`${styles.marketAction} px-md-2`}>
          <Row>
            ...
            <Button variant="savings" size="sm" block disabled onClick={() => handleShow("deposit", i)}>{t('Common.Deposit')}</Button>
            </Col>
            :
            <Col xs={6} className={`${styles.deposit} pl-0 pl-md-2 pr-2`}>
            <Button variant="savings" size="sm" block onClick={() => handleShow("deposit", i)}>{t('Common.Deposit')}</Button>
            </Col>
            }
            <Col xs={6} className={`${styles.borrow} pl-2 pr-0 pr-md-2`}>
              <Button variant="loans" size="sm" block onClick={() => handleShow("borrow", i)}>{t('Common.Borrow')}</Button>
            </Col>
          </Row>
        </Col>
      </Row>
