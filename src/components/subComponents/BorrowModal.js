        ...
        <div>
            <div className={styles.footerInfo}>
                ...
                <div className={styles.tokenBalance}>
                    {(
                        Math.floor(parseFloat(borrowMaxTotal) * 100) / 100
                    ).toFixed(2) +
                        ' ' +
                        props.data.symbol}
                </div>
            ...
            <Modal.Body>
                <Form>
                    ...
                    ) : Number(loanUsedPercentFixed2) > 100 ? (
                        <div className={styles.txnError}>
                    ...
                    {
                        (Number(loanUsedPercentFixed2) > 85 && Number(loanUsedPercentFixed2) <= 100) &&
